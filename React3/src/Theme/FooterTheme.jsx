const FooterTheme ={
        ...
        "root": {
          "base": "w-full rounded-lg bg-[#4A4947] shadow dark:bg-gray-800 md:flex md:items-center md:justify-between",
        ...
        "copyright": {
          "base": "text-sm text-gray-100 dark:text-gray-400 sm:text-center",
        ...
        "brand": {
          ...
          "img": "mr-3 h-8",
          "span": "self-center whitespace-nowrap text-2xl font-semibold text-white dark:text-white"
        }
